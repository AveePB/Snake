...
class Linear_QNet(nn.Module):
    def __init__(self, input_size=11, hidden_size=256, output_size=3): #building the input, hidden and output layer
        super().__init__()
...
class QTrainer:
    def __init__(self, model, lr=0.001, gamma=0.3): #initializing 
        self.lr = lr
        self.gamma = gamma
        self.model = model
